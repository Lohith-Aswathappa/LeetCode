<h2>245. Shortest Word Distance III</h2><h3>Medium</h3><hr><div><p>Given a list of words and two words <em>word1</em> and <em>word2</em>, return the shortest distance between these two words in the list.</p>
